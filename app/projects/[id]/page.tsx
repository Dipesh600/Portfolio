    ...
    <div className="bg-background min-h-screen">
      <header className="bg-card sticky top-0 z-50 shadow-sm border-b border-border">
        <div className="container mx-auto px-4 py-3 flex justify-between items-center">
          <div>
            <h1 className="text-xl md:text-2xl font-poppins font-semibold bg-gradient-to-r from-primary to-primary/50 bg-clip-text text-transparent">Aryan Aditya</h1>
            <p className="text-sm text-muted-foreground font-open-sans">Software Test Engineer</p>
          </div>
          
          <nav>
            <ul className="flex space-x-6">
              <li><a href="/#about" className="font-poppins text-foreground hover:text-primary transition-colors">About</a></li>
              <li><a href="/#projects" className="font-poppins font-medium text-primary">Projects</a></li>
              <li><a href="/#contact" className="font-poppins text-foreground hover:text-primary transition-colors">Contact</a></li>
            </ul>
          </nav>
        </div>
      </header>
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="bg-card rounded-lg shadow-md overflow-hidden border border-border">
          <div className={`h-64 relative bg-gradient-to-r ${project.gradientFrom} ${project.gradientTo}`}>
            <Image
              src={project.image}
              alt={project.title}
              fill
          ...
          <div className="p-6 md:p-8">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
              <div>
                <h1 className="text-3xl font-poppins font-bold bg-gradient-to-r from-primary to-primary/50 bg-clip-text text-transparent">{project.title}</h1>
                <p className="text-muted-foreground mt-1">{project.period}</p>
              </div>
              <Button 
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="md:col-span-2">
                ...
                <h2 className="text-xl font-semibold mb-4 text-foreground">Key Highlights</h2>
                <ul className="space-y-3 mb-6">
                  {project.highlights.map((highlight: string, index: number) => (
                    <li key={index} className="flex items-start">
                      <div className="bg-primary/10 text-primary p-1 rounded-full mt-1 mr-3">
                ...
                <h2 className="text-xl font-semibold mb-4 text-foreground">Project Challenges</h2>
                <p className="text-muted-foreground mb-6 leading-relaxed">
                ...
                <h2 className="text-xl font-semibold mb-4 text-foreground">Lessons Learned</h2>
                <p className="text-muted-foreground mb-6 leading-relaxed">
              ...
              <div>
                <Card className="bg-card/50 border-border">
                  <CardContent className="p-6">
                    ...
                    <h3 className="text-lg font-semibold mb-4 text-foreground">Project Timeline</h3>
                    <p className="text-muted-foreground mb-6">{project.period}</p>

                    <h3 className="text-lg font-semibold mb-4 text-foreground">External Resources</h3>
      ...
      <footer className="bg-card text-foreground py-8 mt-16 border-t border-border">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-4">
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer" 
                className="w-10 h-10 rounded-full bg-accent/50 flex items-center justify-center hover:bg-primary/10 transition-colors"
                aria-label="GitHub"
              >
